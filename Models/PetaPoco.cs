...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        public Database(string connectionStringName)
        {
            ...
            _connectionString = "server=localhost;user id=root;password='';database=buildingdb;AllowUserVariables=True;";// entry.ConnectionString;
            var providerName = "MySql.Data.MySqlClient";// !string.IsNullOrEmpty(entry.ProviderName) ? entry.ProviderName : "System.Data.SqlClient";
            Initialise(DatabaseProvider.Resolve(providerName, false, _connectionString), null);
        }
